      ...
      <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-6 text-slate-900">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-3xl">
          <button 
            ...
            className="p-8 bg-white border border-slate-200 rounded-xl hover:border-red-600 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group text-left flex flex-col items-start"
          >
            ...
            <div className="text-2xl font-bold tracking-wide text-slate-900">จัดการห้องเรียน</div>
        ...
        {view === 'host_menu' && (
          <div className="max-w-2xl mx-auto mt-10 text-center animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <button onClick={() => setView('host_create')} className="p-8 bg-white border border-slate-200 hover:border-slate-900 rounded-xl hover:shadow-lg hover:-translate-y-1 transition-all duration-300 group">
              ...
              <button onClick={() => setView('host_manage')} className="p-8 bg-white border border-slate-200 hover:border-slate-900 rounded-xl hover:shadow-lg hover:-translate-y-1 transition-all duration-300 group">
        ...
        {view === 'host_manage' && (
          <div className="max-w-md mx-auto text-center mt-20 bg-white p-10 border border-slate-200 rounded-xl shadow-sm animate-in fade-in duration-500">
            ...
            <input 
              ...
              className="w-full text-center text-4xl font-mono py-4 rounded-lg border-2 border-slate-200 focus:border-slate-900 focus:ring-4 focus:ring-slate-900/10 shadow-inner outline-none transition-all mb-8 uppercase text-slate-900"
              placeholder="XXXXXX"
            />
            <button 
               onClick={async () => {
           ...
           <div className="max-w-md mx-auto text-center mt-20 bg-white p-10 border border-slate-200 rounded-xl shadow-sm animate-in fade-in">
             ...
             <div className="space-y-4 mb-8">
               <input 
                 ...
                 className="w-full text-center p-4 rounded-lg border-2 border-slate-200 focus:border-red-600 focus:ring-4 focus:ring-red-600/10 shadow-inner outline-none transition-all text-slate-900 font-medium"
               ...
               <input 
                 ...
                 className="w-full text-center text-4xl font-mono py-4 rounded-lg border-2 border-slate-200 focus:border-red-600 focus:ring-4 focus:ring-red-600/10 shadow-inner outline-none transition-all uppercase text-slate-900"
                 placeholder="XXXXXX"
               />
             </div>
             <button 
